...
### Login Page
![Login](portfolio_dashboard/screenshots/login.png)

### Dashboard — Light Mode
![Dashboard Light](portfolio_dashboard/screenshots/dashboard-light.png)

### Dashboard — Dark Mode
![Dashboard Dark](portfolio_dashboard/screenshots/dashboard-dark.png)

### Projects Management
![Projects](portfolio_dashboard/screenshots/projects.png)

### Messages Inbox
![Messages](portfolio_dashboard/screenshots/messages.png)

### Public Portfolio
![Preview Hero](portfolio_dashboard/screenshots/preview-hero.png)

### Public Portfolio — Dark Mode
![Preview Dark](portfolio_dashboard/screenshots/preview-dark.png)
